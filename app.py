...
with tabs[0]:
    ...
    st.markdown("### 🛤️ Professional Journey")
    ...
    <style>
        ...
        .timeline-dot {
            ...
            border-radius: 50%;
            position: absolute;
            left: -42px; /* Adjust to center on line */
            top: 5px;
    ...
    # The HTML Structure with Resume Data
    timeline_html = """
    <div class="timeline-container">
        
        <div class="timeline-item">
            <div class="timeline-dot" style="background-color: #8B5CF6;"></div> <div class="timeline-date">Sep 2024 – Present</div>
        ...
        <div class="timeline-item">
            <div class="timeline-dot" style="background-color: #0078D4;"></div> <div class="timeline-date">May 2019 – Aug 2024</div>
        ...
        <div class="timeline-item">
            <div class="timeline-dot" style="background-color: #2ecc71;"></div> <div class="timeline-date">Aug 2016 – Apr 2019</div>
        ...
        <div class="timeline-item">
            <div class="timeline-dot" style="background-color: #95a5a6;"></div> <div class="timeline-date">2010 – 2016</div>
